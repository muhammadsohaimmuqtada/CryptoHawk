...
def test_authorization_start_uses_pkce_s256_state_nonce_and_server_storage(
    ...
    browser_binding = "server-generated-binding"

    started = asyncio.run(service.begin_authorization(browser_binding=browser_binding))
    ...
    assert repository.login["browser_binding"] == browser_binding
